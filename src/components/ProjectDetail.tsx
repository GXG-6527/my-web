        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20">
            <div className="lg:col-span-4 space-y-12">
              ...
              {project.details.visualStrategy && (
                <section className="p-6 border border-white/10 rounded-2xl">
                  <h4 className="text-zinc-500 uppercase tracking-widest text-xs font-bold mb-4">视觉策略</h4>
                  <p className="text-sm text-zinc-300">{project.details.visualStrategy}</p>
                </section>
              )}
            </div>
